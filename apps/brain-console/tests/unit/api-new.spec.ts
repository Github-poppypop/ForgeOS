...
describe("Phase 11 UI", () => {
  ...
  test("new routes are in NAV and routes map", () => {
    expect(app.includes('["Projects", "projects"]')).toBe(true);
    expect(app.includes('["Wizard", "wizard"]')).toBe(true);
    expect(app.includes('["Settings", "settings"]')).toBe(true);
    expect(app.includes('["Workflows", "workflows"]')).toBe(true);
    expect(app.includes('["Marketplace", "marketplace"]')).toBe(true);
    expect(app.includes('["Plugins", "plugins"]')).toBe(true);
